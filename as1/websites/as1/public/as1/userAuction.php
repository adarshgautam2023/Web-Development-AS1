...
if (isset($_SESSION['user_id'])) {
    ...
    $userAuctions = $userAuctionsQuery->fetchAll(PDO::FETCH_ASSOC);
        ...
        <main>
            ...
            <ul class="productList">
                <?php foreach ($userAuctions as $auction) : ?>
                    <li>
                        <img src="product.png" alt="<?= htmlspecialchars($auction['title']); ?>">
                        <article>
                            <h2><?= $auction['title']; ?></h2>
                            <a href="editAuction.php?id=<?= $auction['auction_id']; ?>" class="more auctionLink">Edit &gt;&gt;</a>
                        </article>
                    </li>
                <?php endforeach; ?>
            </ul>
