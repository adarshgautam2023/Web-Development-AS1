...
<html>
	...
	<body>
		...
		<nav>
			<ul>
				<?php foreach ($categories as $category) : ?>
					<li><a class="categoryLink" href="categoryPage.php?category_id=<?= htmlspecialchars($category['category_id']); ?>"><?php echo $category['name']; ?></a></li>
            <?php endforeach; ?>
			</ul>
		</nav>
        ...
        <section>
			...
			<a href="userAuction.php">MY AUCTION</a>
			<?php if(isset($_SESSION["userDes"]) && $_SESSION["userDes"] == "admin"): ?>
            <a href="adminCategories.php">CATEGORY</a>
        <?php endif; ?>
