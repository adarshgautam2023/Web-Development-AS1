<?php
// Create a new PDO (PHP Data Objects) instance for connecting to the MySQL database
// This instance is configured to connect to the 'assignment1' database on the 'mysql' host
// Using the 'student' username and 'student' password
// Additionally, set PDO error mode to exception for easier error handling
