...
require 'Header.php';
// Include the database functions file (assuming it contains functions like getCategories)
require 'db.php';
// Retrieve the list of categories from the database
$categories = getCategories();
// Check if a category has been successfully deleted, display a message if true
...
<main>
    ...
    <?php
    // Display a success message if a category has been deleted
    if (isset($deleteMessage)) {
        echo '<p class="success-message">' . $deleteMessage . '</p>';
    }
    ?>
    <ul>
