<?php
// Include the 'db.php' file, which likely contains database-related functions
require 'db.php';

// Check if the 'id' parameter is set in the query string (GET request)
if (isset($_GET['id'])) {
        // Retrieve the category ID from the GET parameter
    $categoryId = $_GET['id'];

        // Attempt to delete the category using the deleteCategory function
        $success = deleteCategory($categoryId);
        
            // Redirect to the 'adminCategories.php' page after the deletion attempt
