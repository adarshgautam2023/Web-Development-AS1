    ...
    if (isset($_GET['id'])) {
        ...
        if ($auctionDetails && $auctionDetails['register_id'] == $userID) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $success = updateAuction($pdo, $auctionID, $title, $category, $description, $currentBid);
            ...
            <main>
                ...
                <form method="POST" action="">
                    ...
                    <input type="text" id="title" name="title" value="<?= htmlspecialchars($auctionDetails['title']); ?>" required>

                    <label for="category">Category:</label>
                    <input type="text" id="category" name="category" value="<?= htmlspecialchars($auctionDetails['category']); ?>" required>

                    <label for="description">Description:</label>
                    <textarea id="description" name="description" required><?= htmlspecialchars($auctionDetails['description']); ?></textarea>

                    <label for="currentBid">Current Bid:</label>
                    <input type="text" id="currentBid" name="currentBid" value="<?= htmlspecialchars($auctionDetails['current_bid']); ?>" required>
